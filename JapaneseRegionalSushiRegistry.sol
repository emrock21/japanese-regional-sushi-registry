...
contract JapaneseRegionalSushiRegistry {

    struct SushiStyle {
        string region;          // Tokyo, Osaka, Kyoto, Hokkaido, etc.
        string shopOrFamily;    // real historical shop or lineage
        string styleName;       // Edomae, Oshizushi, Narezushi, etc.
        string ingredients;     // real ingredients
    ...
    function voteStyle(uint256 id, bool like) external {
        ...
        SushiStyle storage s = styles[id];
